...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2018 a las 13:45:25
...
CREATE TABLE `usuarios` (
  ...
  `password` varchar(255) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Tamaño a 255 por si el algoritmo de hash necesita mas caracteres',
...
('Demo 1', 'demo1', '$2y$10$NcBNkS.i36SaNqOHEAYmIO2HAWikwG9wuJQWfQw2CFiVlualMzBnu', '2018-11-09 00:44:43'),
('Demo 2', 'demo2', '$2y$10$WpZRv4F1aIzcdgoReLMXs.q/rQGrXQpMV3gdr.iz.LCySihjb5Pkm', '2018-11-08 21:33:43'),
('Demo 3', 'demo3', '$2y$10$XnW1OfXUT.zRCfoocy.bNuBiirbl3AFNu4jjURrG/UHY8poXWyMNy', '2018-11-09 00:37:22');
