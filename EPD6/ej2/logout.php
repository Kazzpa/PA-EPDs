<html>
    ...
    <body>
        ...
        header('Refresh: 3; URL = index.php'); /* El refresh son los segundos que tardara en redireccionarnos, una ventaja del refresh esque rompe el boton de back
