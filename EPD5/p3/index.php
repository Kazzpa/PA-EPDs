...
<html>
    ...
    <body>
        ...
        function formUpload($limite) {
            ...
            echo'<input type="hidden" name="MAX_FILE_SIZE" value="'.$limite.'" />Selecciona el PDF a subir, maximum size: 5MB.
        ...
        function isUploaded($archivo) {
            ...
            if ($f) {
                ...
                $fila = fgetcsv($f, 999, ";");
                while (!feof($f) && !$bool) {
                    if ($fila[5] == md5_file($archivo['tmp_name'])) {
                        $bool = True;
                    }
                    $fila = fgetcsv($f, 999, ";");
                }
        ...
        function saveToDisk($archivo){
            ...
            if(move_uploaded_file($archivo['tmp_name'],$archivo['name'])){
                echo "archivo guardado en disco";
                $bol = True;
            }else{
                echo "error al guardar en disco";
            }
            return $bol;
        }
